...
for variant in ["Dark", "Light", "Black", "White"]:
    themeName = "Selenized-" + variant
    ...
    if (fin := open(inputFile, "r")):
        ...
        # Parse first line...
        if ((len(line) > 50) and (line[0:6] == "Color ")):
            CIEOffset = line.index("CIE")
            ...
            while (line := fin.readline()):
                if ((len(line) > RGBOffset) and(line[RGBOffset] == "#")):
                    colorName = line[0:CIEOffset - 1].strip()
